...
BREEDS = [
    ...
    ("scout", "敏捷", 10, 1.0, "瘦小、腿快、眼尖，但一次只拿得動一份，也比較短命。",
     {"speed": 1.35, "sense": 1.3, "rest": 0.8, "lifespan": 0.8, "might": 0.6, "health": 2}, "scout.png",
    ...
    ("brute", "壯碩", 8, 1.0, "身強體壯，走得慢，一次搬兩份，活得也久。",
     {"speed": 0.8, "sense": 0.9, "carry": 2, "rest": 1.2, "lifespan": 1.25, "might": 1.6, "health": 5}, "brute.png",
    ...
    ("sage", "聰明", 5, 1.5, "愛動腦筋，很會找食物，也很會叫同伴來幫忙。",
     {"speed": 0.95, "sense": 1.25, "recruit": 3, "lifespan": 1.15, "might": 0.8}, "sage.png",
