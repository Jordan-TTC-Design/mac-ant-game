...
enum HookCLI {
    ...
    static func run(_ args: [String]) -> Never {
        guard args.count >= 2, gameIsRunning() else { exit(0) }
    ...
    private static func ask(kind: String, event: [String: Any], project: String, app: String) -> Never {
        ...
        let dir = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0].appendingPathComponent("GoblinCamp/replies")
        ...
        open("goblincamp://ask", ["kind": kind == "permission" ? "permission" : "reply", "id": id, "project": project, "app": app,
                                  "text": kind == "permission" ? summary(event) : "", "wait": String(Int(maxWait))])
